...
<body>
  <main class="container">
    <h1>Toplane</h1>
    <a href="/toplane/insert" class="btn btn-success mt-3">Novo Top</a>
      ...
      <tbody>
        ...
        while ($r = $resultado->fetch(PDO::FETCH_ASSOC)) {
          ...
          <tr>
            ...
            <td><?= $r['idJg'] ?></td>
            <td>
              <a href="/toplane/updateID/id/<?= $r['idTop'] ?>" class="btn btn-primary">
                Alterar
              </a>
              <a href="/toplane/excluirID/id/<?= $r['idTop'] ?>" class="btn btn-danger">
                Excluir
              </a>
            </td>
          </tr>
