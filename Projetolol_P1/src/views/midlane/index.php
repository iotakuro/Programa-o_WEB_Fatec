...
<body>
  <main class="container">
    <h1>Midlane</h1>
    <a href="/midlane/insert" class="btn btn-success mt-3">Novo Mid</a>
      ...
      <tbody>
        ...
        while ($r = $resultado->fetch(PDO::FETCH_ASSOC)) {
          ...
          <tr>
            ...
            <td><?= $r['idJg'] ?></td>
            <td>
              <a href="/midlane/updateID/id/<?= $r['idMid'] ?>" class="btn btn-primary">
                Alterar
              </a>
              <a href="/midlane/excluirID/id/<?= $r['idMid'] ?>" class="btn btn-danger">
                Excluir
              </a>
            </td>
          </tr>
