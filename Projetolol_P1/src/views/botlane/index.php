...
<body>
  <main class="container">
    <h1>Botlanes</h1>
    <a href="/botlane/insert" class="btn btn-success mt-3">Novo Bot</a>
      ...
      <tbody>
        ...
        while ($r = $resultado->fetch(PDO::FETCH_ASSOC)) {
          ...
          <tr>
            ...
            <td><?= $r['idJg'] ?></td>
            <td>
              <a href="/botlane/updateID/id/<?= $r['idBot'] ?>" class="btn btn-primary">
                Alterar
              </a>
              <a href="/botlane/excluirID/id/<?= $r['idBot'] ?>" class="btn btn-danger">
                Excluir
              </a>
            </td>
          </tr>
