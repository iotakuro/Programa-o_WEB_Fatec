...
<html lang="en">
  <head>
    ...
    <title>Deletar Campeão</title>
  </head>
  <body>
    <main class="container">
        <h3>Deletar Campeão</h3>
        <form action="/botlane/destroy" method="post">
            <input type="hidden" name="idBot" value="<?= $resultado['idBot'] ?>">
            <div class="row">
                ...
                <div class="col-6 mt-3">
                    <label for="idJg" class="form-label">idJg:</label>
